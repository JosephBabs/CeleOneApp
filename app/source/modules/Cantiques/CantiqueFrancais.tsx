...
export default function CantiqueFrancais({ navigation }: any) {
  ...
  const fetchCantiques = async () => {
    try {
      setLoading(true);
      const q = query(collection(db, 'cantiques'), where('language', '==', 'francais'));
    ...
    <>
      <View style={styles.headerBar}>
        <View style={styles.headerLeft}>
          ...
          <View>
            <Text style={styles.headerTitle}>{t('cantiques.francais_title')}</Text>
      ...
      <View style={styles.modeRow}>
        <View style={styles.modeChip}>
          ...
          <Text style={styles.modeChipText}>{t('cantiques.lang_francais')}</Text>
        </View>
