    ...
    <View style={styles.postCard}>
      <View style={styles.postHeader}>
        <View>
          ...
          <Text style={styles.postAuthor}>{item.posterName || item.author || "Admin"}</Text>
        </View>
      ...
      <View style={styles.engagementRow}>
        ...
        <View style={styles.engagementItem}>
          ...
          <Text style={styles.engagementText}>{item.comments || 0} comments</Text>
        </View>
        <View style={styles.engagementItem}>
            ...
            {newPost.category === "events" && (
              <>
                ...
                <TextInput
                  ...
                  onChangeText={t => setNewPost({ ...newPost, eventLocation: t })}
                />
                <TextInput
                  style={styles.textarea}
        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined}>
          <View style={styles.form}>
            ...
            <View style={styles.editButtons}>
              <TouchableOpacity style={styles.cancelBtn} onPress={() => { setShowEditForm(false); resetForm(); setEditingPost(null); }}>
                <Text style={styles.cancelText}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.submitBtn} onPress={handleUpdatePost}>
...
const styles = StyleSheet.create({
  ...
  postCard: { padding: 14, borderRadius: 8, backgroundColor: "#fafafa", marginBottom: 12 },
  postHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 },
  postCategory: { fontSize: 12, color: COLORS.light.primary, fontWeight: "bold" },
  ...
  engagementRow: { flexDirection: "row", justifyContent: "space-around", paddingVertical: 8, borderTopWidth: 1, borderBottomWidth: 1, borderColor: "#eee", marginBottom: 10 },
